...
public static class Program
{
    ...
    private static void ListBenchmarks()
    {
        ...
        Console.WriteLine();
        Console.WriteLine("8. FFmpegPipelineBenchmarks");
        ...
        Console.WriteLine();
        Console.WriteLine("9. NativeInteropBenchmarks");

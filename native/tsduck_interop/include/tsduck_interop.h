...
#define TSDUCK_INTEROP_VERSION "1.0.0"
    ...
    typedef void (*TsDuckCorrectionCallback)(double correction_ms,         // Amount corrected
    ...
    typedef void (*TsDuckViolationCallback)(const char* violation_type, const char* details, void* user_data);
    ...
    typedef void (*TsDuckLogCallback)(int32_t level, const char* component, const char* message, void* user_data);
    ...
    TSDUCK_API TsDuckAnalyzerHandle tsduck_analyzer_create(TsDuckContextHandle ctx, const TsDuckConfigNative* config);
    ...
    TSDUCK_API int32_t tsduck_analyzer_feed(TsDuckAnalyzerHandle analyzer, const uint8_t* data, int32_t length);
    ...
    /// @param length Number of bytes to process.
    /// @return Number of packets processed, or negative error code.
    TSDUCK_API int32_t tsduck_analyzer_feed_restamp(TsDuckAnalyzerHandle analyzer, uint8_t* data, int32_t length);
    ...
    TSDUCK_API bool tsduck_analyzer_get_metrics(TsDuckAnalyzerHandle analyzer, TsDuckMetricsNative* out_metrics);
    ...
    TSDUCK_API bool tsduck_analyzer_get_pcr_analysis(TsDuckAnalyzerHandle analyzer, PcrAnalysisNative* out_analysis);
    ...
    TSDUCK_API bool tsduck_analyzer_set_pcr_jitter_threshold(TsDuckAnalyzerHandle analyzer, double max_jitter_us);
    ...
    TSDUCK_API bool tsduck_analyzer_get_iat_analysis(TsDuckAnalyzerHandle analyzer, IatAnalysisNative* out_analysis);
    ...
    /// @return true if threshold was set, false on error.
    TSDUCK_API bool tsduck_analyzer_set_iat_jitter_threshold(TsDuckAnalyzerHandle analyzer, double max_jitter_us);
    ...
    TSDUCK_API bool tsduck_analyzer_get_bitrate_analysis(TsDuckAnalyzerHandle analyzer,
    ...
    TSDUCK_API int32_t tsduck_analyzer_get_pid_info_extended(TsDuckAnalyzerHandle analyzer,
                                                             TsDuckPidInfoExtended* out_pids, int32_t max_pids);
    ...
    TSDUCK_API void tsduck_analyzer_set_metrics_callback(TsDuckAnalyzerHandle analyzer, TsDuckMetricsCallback callback,
                                                         void* user_data);

    /// Set callback for quality violations.
    /// The callback will be invoked when TR 101 290 violations are detected.
    /// Set to NULL to disable callbacks.
    TSDUCK_API void tsduck_analyzer_set_violation_callback(TsDuckAnalyzerHandle analyzer,
                                                           TsDuckViolationCallback callback, void* user_data);
    ...
    TSDUCK_API bool tsduck_analyzer_configure_restamp(TsDuckAnalyzerHandle analyzer, int32_t mode, int32_t smooth_pcr,
    ...
    TSDUCK_API void tsduck_analyzer_handle_switch(TsDuckAnalyzerHandle analyzer, int64_t last_output_pts,
    ...
    TSDUCK_API bool tsduck_analyzer_get_restamp_statistics(TsDuckAnalyzerHandle analyzer,
    ...
    TSDUCK_API bool tsduck_analyzer_is_restamping_enabled(TsDuckAnalyzerHandle analyzer);
    ...
    TSDUCK_API bool tsduck_analyzer_get_av_sync_analysis(TsDuckAnalyzerHandle analyzer,
    ...
    TSDUCK_API int32_t tsduck_analyzer_get_pts_samples(TsDuckAnalyzerHandle analyzer, PtsDtsSampleNative* out_samples,
                                                       int32_t max_samples);
    ...
    TSDUCK_API int32_t tsduck_analyzer_get_programs(TsDuckAnalyzerHandle analyzer,
                                                    TsDuckProgramInfoNative* out_programs, int32_t max_programs);
    ...
    typedef void (*TsDuckScte35Callback)(const Scte35EventNative* event, void* user_data);
    ...
    TSDUCK_API int32_t tsduck_analyzer_get_scte35_events(TsDuckAnalyzerHandle analyzer, Scte35EventNative* out_events,
                                                         int32_t max_events);
    ...
    TSDUCK_API bool tsduck_analyzer_get_current_scte35_event(TsDuckAnalyzerHandle analyzer,
    ...
    /// @param user_data User-provided context passed to callback.
    TSDUCK_API void tsduck_analyzer_set_scte35_callback(TsDuckAnalyzerHandle analyzer, TsDuckScte35Callback callback,
                                                        void* user_data);
    ...
    TSDUCK_API bool tsduck_analyzer_get_video_codec_info(TsDuckAnalyzerHandle analyzer, uint16_t video_pid,
    ...
    TSDUCK_API bool tsduck_analyzer_get_parameter_sets(TsDuckAnalyzerHandle analyzer, uint16_t video_pid,
    ...
    TSDUCK_API bool tsduck_analyzer_has_idr_frame(TsDuckAnalyzerHandle analyzer, uint16_t video_pid);
    ...
    TSDUCK_API bool tsduck_analyzer_register_video_pid(TsDuckAnalyzerHandle analyzer, uint16_t video_pid,
                                                       uint8_t stream_type);
    ...
    typedef void (*TsDuckStreamerOutputCallback)(const uint8_t* data,
    ...
    TSDUCK_API TsDuckStreamerHandle tsduck_streamer_create(const TsDuckStreamerConfigNative* config,
    ...
    TSDUCK_API int32_t tsduck_streamer_add_url(TsDuckStreamerHandle streamer, const char* url);
    ...
    /// @return TSDUCK_OK or error code.
    TSDUCK_API int32_t tsduck_streamer_add_url_with_score(TsDuckStreamerHandle streamer, const char* url,
                                                          double health_score);
    ...
    TSDUCK_API int32_t tsduck_streamer_update_url_score(TsDuckStreamerHandle streamer, int32_t url_index,
                                                        double new_score);
    ...
    TSDUCK_API double tsduck_streamer_get_url_score(TsDuckStreamerHandle streamer, int32_t url_index);
    ...
    TSDUCK_API void tsduck_streamer_set_output_fd(TsDuckStreamerHandle streamer, int32_t fd);

    /// Set the output data callback.
    /// Called from the streaming thread with restamped TS data.
    TSDUCK_API void tsduck_streamer_set_output_callback(TsDuckStreamerHandle streamer,
                                                        TsDuckStreamerOutputCallback callback, void* user_data);

    /// Set the event callback.
    /// Called from the streaming thread on state changes.
    TSDUCK_API void tsduck_streamer_set_event_callback(TsDuckStreamerHandle streamer,
                                                       TsDuckStreamerEventCallback callback, void* user_data);
    ...
    TSDUCK_API bool tsduck_streamer_get_status(TsDuckStreamerHandle streamer, TsDuckStreamerStatusNative* out_status);
    ...
    TSDUCK_API TsDuckAnalyzerHandle tsduck_streamer_get_analyzer(TsDuckStreamerHandle streamer);
    ...
    TSDUCK_API int32_t tsduck_streamer_get_init_packets(TsDuckStreamerHandle streamer, uint8_t* out_buffer,
                                                        int32_t buffer_size, int32_t* out_bytes_written);
    ...
    TSDUCK_API int32_t tsduck_streamer_set_shared_memory_output(TsDuckStreamerHandle streamer, const char* name,
    ...
    TSDUCK_API const char* tsduck_streamer_get_shared_memory_name(TsDuckStreamerHandle streamer);

    /// Check if the streamer is in shared memory output mode.
    /// @param streamer The streamer handle.
    /// @return 1 if in shared memory mode, 0 otherwise.
    TSDUCK_API int32_t tsduck_streamer_is_shared_memory_mode(TsDuckStreamerHandle streamer);
...
#define NETWORK_CONFIG_DOH_URL_MAX_LEN    512
    ...
    TSDUCK_API int32_t tsduck_network_config_add_dns_server(NetworkConfigNative* config, const char* server);

    /// Set the DNS-over-HTTPS URL.
    /// @param config The configuration to modify.
    /// @param url DoH URL (e.g., "https://cloudflare-dns.com/dns-query").
    TSDUCK_API void tsduck_network_config_set_doh_url(NetworkConfigNative* config, const char* url);
    ...
    TSDUCK_API int32_t tsduck_streamer_set_network_config(TsDuckStreamerHandle streamer,
    ...
    TSDUCK_API void* tsduck_shm_producer_create(const char* name, uint32_t slot_count, uint32_t slot_size);
    ...
    TSDUCK_API int32_t tsduck_shm_producer_write(void* producer, const uint8_t* data, uint32_t length,
    ...
    TSDUCK_API void tsduck_shm_producer_set_error(void* producer, uint32_t code, const char* message);
    ...
    TSDUCK_API int32_t tsduck_registry_add_provider(ChannelRegistryHandle registry,
    ...
    TSDUCK_API int32_t tsduck_registry_add_stream(ChannelRegistryHandle registry, int32_t provider_index,
                                                  int32_t stream_id, const char* name, const char* icon_url);
    ...
    TSDUCK_API bool tsduck_registry_get_stats(ChannelRegistryHandle registry, RegistryStatsNative* out_stats);
    ...
    TSDUCK_API int32_t tsduck_registry_enumerate_channels(ChannelRegistryHandle registry,
                                                          RegistryChannelListEntryNative* out_entries,
                                                          int32_t max_count, int32_t offset);
    ...
    TSDUCK_API bool tsduck_registry_get_channel_info(ChannelRegistryHandle registry, int64_t guid_high,
                                                     int64_t guid_low, RegistryChannelListEntryNative* out_entry);
    ...
    TSDUCK_API bool tsduck_registry_add_guid_alias(ChannelRegistryHandle registry, int64_t alias_high,
                                                   int64_t alias_low, int32_t provider_index, int32_t stream_id);
    ...
    TSDUCK_API void tsduck_registry_report_api_success(ChannelRegistryHandle registry, int32_t provider_index,
                                                       int32_t latency_ms);
    ...
    TSDUCK_API void tsduck_registry_report_api_failure(ChannelRegistryHandle registry, int32_t provider_index,
                                                       int32_t error_type);
    ...
    /// @param max_count Maximum entries to write (buffer size).
    /// @return Number of entries written.
    TSDUCK_API int32_t tsduck_registry_get_provider_status(ChannelRegistryHandle registry,
                                                           RegistryProviderStatusNative* out_status, int32_t max_count);
    ...
    /// @param user_data User-provided context pointer.
    typedef void (*TsDuckRegistryHealthCallback)(int32_t provider_index, const char* event_type, const char* details,
                                                 void* user_data);
    ...
    /// @param callback The callback function, or NULL to disable.
    /// @param user_data User-provided context passed to callback.
    TSDUCK_API void tsduck_registry_set_health_callback(ChannelRegistryHandle registry,
                                                        TsDuckRegistryHealthCallback callback, void* user_data);
    ...
    /// @return TSDUCK_OK on success.
    TSDUCK_API int32_t tsduck_streamer_set_registry(TsDuckStreamerHandle streamer, ChannelRegistryHandle registry);
    ...
    /// @return TSDUCK_OK on success.
    TSDUCK_API int32_t tsduck_streamer_set_channel_guid(TsDuckStreamerHandle streamer, int64_t guid_high,
                                                        int64_t guid_low);
    ...
    TSDUCK_API int32_t tsduck_streamer_get_provider_state(TsDuckStreamerHandle streamer, int32_t provider_index);
    ...
    TSDUCK_API bool tsduck_streamer_get_provider_health(TsDuckStreamerHandle streamer, int32_t provider_index,
    ...
    TSDUCK_API int32_t tsduck_streamer_get_isolated_times(TsDuckStreamerHandle streamer, int32_t provider_index);

    /// Run outlier detection manually (for testing).
    /// Normally called periodically by the health system.
    /// @param streamer The streamer handle.
    TSDUCK_API void tsduck_streamer_run_outlier_detection(TsDuckStreamerHandle streamer);

    /// Get the number of registered providers in the health system.
    /// @param streamer The streamer handle.
    /// @return Provider count, or 0 on error.
    TSDUCK_API int32_t tsduck_streamer_get_provider_count(TsDuckStreamerHandle streamer);

    /// Reset all providers to Active state (for testing).
    /// @param streamer The streamer handle.
    TSDUCK_API void tsduck_streamer_reset_all_providers(TsDuckStreamerHandle streamer);

    /// Force eject a provider (for testing).
    /// @param streamer The streamer handle.
    /// @param provider_index Index of the provider (0-based).
    /// @param duration_ms Duration of ejection in milliseconds.
    TSDUCK_API void tsduck_streamer_force_eject_provider(TsDuckStreamerHandle streamer, int32_t provider_index,
                                                         int32_t duration_ms);
    ...
    TSDUCK_API int32_t tsduck_streamer_get_dns_failure_count(TsDuckStreamerHandle streamer, int32_t provider_index);
    ...
    TSDUCK_API int32_t tsduck_streamer_simulate_dns_failure(TsDuckStreamerHandle streamer, int32_t provider_index);

    /// Reset DNS failure count for a provider (simulates successful connection).
    /// @param streamer Streamer handle.
    /// @param provider_index Index of the provider (0-based).
    TSDUCK_API void tsduck_streamer_reset_dns_failure_count(TsDuckStreamerHandle streamer, int32_t provider_index);
